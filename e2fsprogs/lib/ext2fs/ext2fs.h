...
extern errcode_t ext2fs_zone_align_data(const char *device_name,
					ext2_filsys fs, __u64 bytes_per_zone);
extern errcode_t ext2fs_zone_align_journal(const char *device_name,
					   ext2_filsys fs, unsigned int blocks,
